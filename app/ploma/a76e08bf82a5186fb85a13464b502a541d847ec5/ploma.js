...
export class Ploma {
    constructor(transparent, width = 800, height = 800) {
    ...
    setupCanvas(w, h) {
        ...
        console.log("setupCanvas", w, h);
        this.w = w;
        this.h = h;
        this.w_4 = this.w * 4;
        this.paperColor = this.transparent ? "transparent" : "rgb(240, 235, 219)";
        this.clear();
    }
